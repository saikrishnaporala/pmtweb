!(function (e, t) {
    ...
    var p = (function (n) {
        ...
        (C = ae.setDocument = function (e) {
            ...
            return (
                i !== x &&
                    ...
                    (E = !r(x)),
                    y !== x && (n = x.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", oe, !1) : n.attachEvent && n.attachEvent("onunload", oe)),
                    ...
                    (d.matchesSelector = J.test((c = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector))) &&
                        ce(function (e) {
        ...
        (ae.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== x && C(e), d.matchesSelector && E && !D[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t))))
                try {
                    var n = c.call(e, t);
                    ...
                    return 1 === g && 0 === m
                        ...
                        : function (e, t, n) {
                              ...
                              if (c) {
                                  if (v) {
                                      for (; u; ) {
                                          for (s = e; (s = s[u]); ) if (_ ? s.nodeName.toLowerCase() === h : 1 === s.nodeType) return !1;
                                  ...
                                  if (((l = [y ? c.firstChild : c.lastChild]), y && f)) {
                                      for (
                                          d = (a = (i = (r = (o = (s = c)[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]) && i[2], s = a && c.childNodes[a];
                                      ...
                                      for (
                                          ;
                                          (s = (++a && s && s[u]) || (d = a = 0) || l.pop()) &&
                                          ((_ ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++d || (f && ((r = (o = s[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, d]), s !== e));
            ...
            return (
                ...
                ue(function (e, t, n, i) {
                    var r,
                        ...
                        f = g ? (v || (e ? d : u || m) ? [] : t) : h;
                    if ((g && g(h, f, n, i), m)) for (r = Ce(f, l), m(r, [], n, i), o = r.length; o--; ) (s = r[o]) && (f[l[o]] = !(h[l[o]] = s));
                    if (e) {
                        if (v || d) {
                            if (v) {
            ...
            for (
                ...
                if ((t = b.relative[e[a].type])) c = [be(we(c), t)];
                    ...
                    if ((t = b.filter[e[a].type].apply(null, e[a].matches))[T]) {
                        ...
                        return xe(1 < a && we(c), 1 < a && _e(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(B, "$1"), t, a < n && Ee(e.slice(a, n)), n < i && Ee((e = e.slice(n))), n < i && _e(e));
                    }
                    c.push(t);
                }
            return we(c);
        ...
        return (
            ...
            (p = ae.tokenize = function (e, t) {
                ...
                for (s = e, a = [], l = b.preFilter; s; ) {
                    ...
                    (n = !1),
                    (i = z.exec(s)) && ((n = i.shift()), r.push({ value: n, type: i[0].replace(B, " ") }), (s = s.slice(n.length))),
                    b.filter))
                        !(i = Q[o].exec(s)) || (l[o] && !(i = l[o](i))) || ((n = i.shift()), r.push({ value: n, type: o, matches: i }), (s = s.slice(n.length)));
                    if (!n) break;
                }
    ...
    ((T.fn.init = function (e, t, n) {
        ...
        if (((n = n || k), "string" == typeof e)) {
            ...
            if (i[1]) {
                if (((t = t instanceof T ? t[0] : t), T.merge(this, T.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : E, !0)), N.test(i[1]) && T.isPlainObject(t))) for (i in t) y(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this;
            }
                                                ...
                                                (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    y(t)
                                                        ? a
                                                            ...
                                                            : (l++, t.call(e, u(l, o, M, a), u(l, o, P, a), u(l, o, M, o.notifyWith)))
                                                        : (s !== M && ((n = void 0), (i = [e])), (a || o.resolveWith)(n, i));
                                            }
                                        },
                                        t = a
                                            ? e
    ...
    (T.fn.ready = function (e) {
        ...
        (T.ready.then = F.then),
        "complete" === E.readyState || ("loading" !== E.readyState && !E.documentElement.doScroll) ? x.setTimeout(T.ready) : (E.addEventListener("DOMContentLoaded", B), x.addEventListener("load", B));
                    ...
                    ? ("none" === n && ((u[c] = Y.get(i, "display") || null), u[c] || (i.style.display = "")),
                      "" === i.style.display &&
                          ...
                          (u[c] =
                              ...
                              (s = (r = i).ownerDocument),
                              (a = r.nodeName),
                              (l = ce[a]) || ((o = s.body.appendChild(s.createElement(a))), (l = T.css(o, "display")), o.parentNode.removeChild(o), "none" === l && (l = "block"), (ce[a] = l)))))
    ...
    function we(e, t, n, i, r) {
        ...
        for (h.textContent = "", d = 0; (o = f[d++]); )
            ...
            else if (((u = oe(o)), (s = me(h.appendChild(o), "script")), u && ve(s), n)) for (c = 0; (o = s[c++]); ) pe.test(o.type || "") && n.push(o);
        return h;
    }
                ...
                for (
                    ...
                    (d = g = (a = Ee.exec(e[u]) || [])[1]),
                        ...
                        d &&
                            ...
                            (h = T.event.special[d] || {}),
                            (c = T.extend({ type: d, origType: g, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && T.expr.match.needsContext.test(r), namespace: p.join(".") }, o)),
                            (f = l[d]) || (((f = l[d] = []).delegateCount = 0), (h.setup && !1 !== h.setup.call(t, i, p, s)) || (t.addEventListener && t.addEventListener(d, s))),
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(H) || [""]).length; u--; )
                    if (((d = g = (a = Ee.exec(t[u]) || [])[1]), (p = (a[2] || "").split(".").sort()), d)) {
                        for (h = T.event.special[d] || {}, f = l[(d = (i ? h.delegateType : h.bindType) || d)] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--; )
                            (c = f[o]),
                                (!r && g !== c.origType) ||
                                    (n && n.guid !== c.guid) ||
                                    (a && !a.test(c.namespace)) ||
                                    (i && i !== c.selector && ("**" !== i || !c.selector)) ||
                                    (f.splice(o, 1), c.selector && f.delegateCount--, h.remove && h.remove.call(e, c));
    ...
    function Me(e, t) {
        var n, i, r, o, s, a, l, u;
        if (1 === t.nodeType) {
            if (Y.hasData(e) && ((o = Y.access(e)), (s = Y.set(t, o)), (u = o.events))) for (r in (delete s.handle, (s.events = {}), u)) for (n = 0, i = u[r].length; n < i; n++) T.event.add(t, r, u[r][n]);
                ...
                for (u = s[s.length - 1].ownerDocument, T.map(s, He), c = 0; c < a; c++)
                    (l = s[c]),
                        pe.test(l.type || "") &&
                            ...
                            T.contains(u, l) &&
                            (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }) : b(l.textContent.replace(Le, ""), l, u));
        }
        return n;
    }
    function qe(e, t, n) {
    ...
    T.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n) for (o = o || me(e), s = s || me(c), i = 0, r = o.length; i < r; i++) Me(o[i], s[i]);
                else Me(e, c);
    ...
    function Ue(e, t, n) {
        ...
        return (
            (n = n || Fe(e)) &&
                ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = T.style(e, t)),
                !v.pixelBoxStyles() && We.test(s) && Be.test(t) && ((i = a.width), (r = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = r), (a.maxWidth = o))),
            void 0 !== s ? s + "" : s
        );
    }
    function ze(e, t) {
    ...
    function et(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += T.css(e, n + ie[s], !0, r)),
                i
                    ? ("content" === n && (l -= T.css(e, "padding" + ie[s], !0, r)), "margin" !== n && (l -= T.css(e, "border" + ie[s] + "Width", !0, r)))
                    : ((l += T.css(e, "padding" + ie[s], !0, r)), "padding" !== n ? (l += T.css(e, "border" + ie[s] + "Width", !0, r)) : (a += T.css(e, "border" + ie[s] + "Width", !0, r)));
    ...
    function tt(e, t, n) {
        ...
        return (
            ((!v.boxSizingReliable() && r) || "auto" === s || (!parseFloat(s) && "inline" === T.css(e, "display", !1, i))) && e.getClientRects().length && ((r = "border-box" === T.css(e, "boxSizing", !1, i)), (o = a in e) && (s = e[a])),
            ...
            T.cssHooks[l] = {
                ...
                set: function (e, t, n) {
                    var i,
                        ...
                        a = n ? et(e, l, n, s, r) : 0;
                    return (
                        s && o && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(r[l]) - et(e, l, "border", !1, r) - 0.5)),
                        a && (i = ne.exec(t)) && "px" !== (i[3] || "px") && ((e.style[l] = t), (t = T.css(e, l))),
                        Ze(0, t, a)
                    );
                },
            };
    ...
    (T.Animation = T.extend(dt, {
        ...
        T.each({ slideDown: ht("show"), slideUp: ht("hide"), slideToggle: ht("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, i) {
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? T.prop(e, t, n)
                        : ((1 === o && T.isXMLDoc(e)) || (r = T.attrHooks[t.toLowerCase()] || (T.expr.match.bool.test(t) ? pt : void 0)),
                          void 0 !== n
                              ? null === n
        ...
        T.fn.extend({
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && s
                    ...
                    : this.each(function () {
                          var e, t, n, i;
                          if (s) for (t = 0, n = T(this), i = bt(r); (e = i[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
            ...
            hasClass: function (e) {
                var t,
                    n,
                    i = 0;
                for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && -1 < (" " + yt(_t(n)) + " ").indexOf(t)) return !0;
                return !1;
            },
        });
    var wt = /\r/g;
    ...
    (Ft.href = Et.href),
        T.extend({
            ...
            ajax: function (e, t) {
                ...
                if (
                    (_.promise(C),
                    (m.url = ((e || m.url || Et.href) + "").replace(Mt, Et.protocol + "//")),
                ...
                m.hasContent
                    ...
                    : ((o = m.url.slice(h.length)),
                      m.data && (m.processData || "string" == typeof m.data) && ((h += (St.test(h) ? "&" : "?") + m.data), delete m.data),
                      !1 === m.cache && ((h = h.replace(jt, "$1")), (o = (St.test(h) ? "&" : "?") + "_=" + Tt++ + o)),
                      (m.url = h + o)),
                m.ifModified && (T.lastModified[h] && C.setRequestHeader("If-Modified-Since", T.lastModified[h]), T.etag[h] && C.setRequestHeader("If-None-Match", T.etag[h])),
                ((m.data && m.hasContent && !1 !== m.contentType) || t.contentType) && C.setRequestHeader("Content-Type", m.contentType),
                C.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : m.accepts["*"]),
                m.headers))
                ...
                function u(e, t, n, i) {
                    ...
                    p ||
                        ...
                        r
                            ? (m.ifModified && ((l = C.getResponseHeader("Last-Modified")) && (T.lastModified[h] = l), (l = C.getResponseHeader("etag")) && (T.etag[h] = l)),
                        ...
                        b.fireWith(v, [C, u]),
                        g && (y.trigger("ajaxComplete", [C, m]), --T.active || T.event.trigger("ajaxStop")));
                }
                return C;
            },
                            ...
                            return function () {
                                o &&
                                    ...
                                    "abort" === e
                                        ...
                                        : t(Vt[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? { binary: i.response } : { text: i.responseText }, i.getAllResponseHeaders()));
                            };
                        }),
                            (i.onload = o()),
        ...
        (T.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (o = !n && []),
                  (r = N.exec(e)) ? [t.createElement(r[1])] : ((r = we([e], t, o)), o && o.length && T(o).remove(), T.merge([], r.childNodes)));
            var i, r, o;
        }),
        ...
        (T.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === u && (e.style.position = "relative"),
                    ...
                    (o = T.css(e, "top")),
                    (l = T.css(e, "left")),
                    ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? ((s = (i = c.position()).top), (r = i.left)) : ((s = parseFloat(o) || 0), (r = parseFloat(l) || 0)),
    ...
    (function (e, t) {
        ...
        p(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', c._handleDismiss(new c())),
        ...
        var h = "button",
            ...
            b = { CLICK_DATA_API: "click" + d + m, FOCUS_BLUR_DATA_API: "focus" + d + m + " blur" + d + m },
            w = (function () {
                function n(e) {
                    this._element = e;
                }
                ...
                return (
                    ...
                    (e._slide = function (e, t) {
                        ...
                        if (((r = e === N ? ((n = "carousel-item-left"), (i = "carousel-item-next"), "left") : ((n = "carousel-item-right"), (i = "carousel-item-prev"), "right")), l && p(l).hasClass(O))) this._isSliding = !1;
                            ...
                            var h = p.Event(k.SLID, { relatedTarget: l, direction: r, from: a, to: u });
        ...
        p(document).on(k.CLICK_DATA_API, "[data-slide], [data-slide-to]", R._dataApiClickHandler),
        ...
        var H = "collapse",
            ...
            B = { SHOW: "show" + P, SHOWN: "shown" + P, HIDE: "hide" + P, HIDDEN: "hidden" + P, CLICK_DATA_API: "click" + P + ".data-api" },
            U = "show",
            z = "collapse",
            V = "collapsing",
            $ = "collapsed",
                        ...
                        if (
                            !(
                                ...
                                (this._parent &&
                                    ...
                                    (e = null),
                                e && (t = p(e).not(this._selector).data(M)) && t._isTransitioning)
                            )
                        ) {
        ...
        function fe(e, t, n, i) {
            return Math.max(
                ...
                n["offset" + e],
                n["scroll" + e],
                se(10) ? parseInt(n["offset" + e]) + parseInt(i["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0
            );
        }
        function de(e) {
            var t = e.body,
        ...
        function _e(e, t) {
            ...
            var h = ve({ top: o.top - s.top - u, left: o.left - s.left - c, width: o.width, height: o.height });
            ...
            if ("viewport" === i)
                o = (function (e) {
                    var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                        ...
                        s = t ? 0 : ce(n),
                        a = t ? 0 : ce(n, "left");
                    return ve({ top: s - i.top + i.marginTop, left: a - i.left + i.marginLeft, width: r, height: o });
                })(s, r);
            else {
                var a = void 0;
        ...
        function Ce(e, t, i, n, r) {
            ...
            var s = we(i, n, o, r),
                ...
                l = Object.keys(a)
                    .map(function (e) {
                        return me({ key: e }, a[e], { area: ((t = a[e]), t.width * t.height) });
                        var t;
                    })
                    .sort(function (e, t) {
        ...
        function Le(n, i) {
            Object.keys(i).forEach(function (e) {
                var t = "";
                -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && Oe(i[e]) && (t = "px"), (n.style[e] = i[e] + t);
            });
        }
                        ...
                        fn: function (e) {
                            ...
                            if (i) {
                                var r = e.offsets,
                                    ...
                                    l = a ? "left" : "top",
                                    u = a ? "width" : "height",
                                    c = { start: ge({}, l, o[l]), end: ge({}, l, o[l] + o[u] - s[u]) };
                            ...
                            return (
                                b.forEach(function (e, t) {
                                    ...
                                    (s || h || d) &&
                                        ...
                                        (p.placement = v + (_ ? "-" + _ : "")),
                                        (p.offsets.popper = me({}, p.offsets.popper, Se(p.instance.popper, p.offsets.reference, p.placement))),
                        ...
                        fn: function (e, t) {
                            ...
                            var s,
                                ...
                                S =
                                    ...
                                    (_ = a ? h : d),
                                    { left: (y = a ? (m || v || p % 2 == g % 2 ? h : f) : d)(p % 2 == 1 && g % 2 == 1 && !v && a ? u.left - 1 : u.left), top: _(u.top), bottom: _(u.bottom), right: y(u.right) }),
                                A = "bottom" === n ? "top" : "bottom",
                                D = "right" === i ? "left" : "right",
                                N = Ie("transform");
                            if (
                                ((w = "bottom" === A ? ("HTML" === x.nodeName ? -x.clientHeight + S.bottom : -E.height + S.bottom) : S.top),
                                (b = "right" === D ? ("HTML" === x.nodeName ? -x.clientWidth + S.right : -E.width + S.right) : S.left),
                                C && N)
                            )
                                (T[N] = "translate3d(" + b + "px, " + w + "px, 0)"), (T[A] = 0), (T[D] = 0), (T.willChange = "transform");
                            else {
                                var I = "bottom" === A ? -1 : 1,
                                    k = "right" === D ? -1 : 1;
                    ...
                    applyStyle: {
                        ...
                        fn: function (e) {
                            ...
                            return (
                                ...
                                e.arrowElement && Object.keys(e.arrowStyles).length && Le(e.arrowElement, e.arrowStyles),
                                e
                            );
                        },
                        onLoad: function (e, t, n, i, r) {
                            ...
                            return t.setAttribute("x-placement", s), Le(t, { position: n.positionFixed ? "fixed" : "absolute" }), n;
                        },
            ...
            We = (function () {
                function o(e, t) {
                    ...
                    !(function (e, t) {
                        ...
                        Object.keys(me({}, o.Defaults.modifiers, i.modifiers)).forEach(function (e) {
                            ...
                            value: function () {
                                return function () {
                                    if (!this.state.isDestroyed) {
                                        ...
                                        (e.offsets.reference = xe(this.state, this.popper, this.reference, this.options.positionFixed)),
                                            (e.placement = Ce(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding)),
                                            (e.originalPlacement = e.placement),
                                            (e.positionFixed = this.options.positionFixed),
                                            (e.offsets.popper = Se(this.popper, e.offsets.reference, e.placement)),
                                ...
                                return function () {
                                    this.state.eventsEnabled ||
                                        (this.state = (function (e, t, n, i) {
                                            (n.updateBound = i), ke(e).addEventListener("resize", n.updateBound, { passive: !0 });
                                            var r = ie(e);
                                            return (
                                                (function e(t, n, i, r) {
                                                    var o = "BODY" === t.nodeName,
                                                        s = o ? t.ownerDocument.defaultView : t;
                                                    s.addEventListener(n, i, { passive: !0 }), o || e(ie(s.parentNode), n, i, r), r.push(s);
        ...
        var Fe = "dropdown",
            ...
            Xe = { HIDE: "hide" + Ue, HIDDEN: "hidden" + Ue, SHOW: "show" + Ue, SHOWN: "shown" + Ue, CLICK: "click" + Ue, CLICK_DATA_API: "click" + Ue + ze, KEYDOWN_DATA_API: "keydown" + Ue + ze, KEYUP_DATA_API: "keyup" + Ue + ze },
            Qe = "disabled",
            Ke = "show",
            Ye = "dropdown-menu-right",
            Ge = '[data-toggle="dropdown"]',
            Je = ".dropdown-menu",
            Ze = { offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic" },
            ...
            tt = (function () {
                ...
                return (
                    ...
                    (e._getPlacement = function () {
                        ...
                        return (
                            e.hasClass("dropup")
                                ? ((t = "top-start"), p(this._menu).hasClass(Ye) && (t = "top-end"))
                    ...
                    (u._dataApiKeydownHandler = function (e) {
                        if (
                            (/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || p(e.target).closest(Je).length))) : $e.test(e.which)) &&
                            (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(Qe))
                        ) {
                        ...
                        if (!this._isShown && !this._isTransitioning) {
                            ...
                            p(this._element).trigger(n),
                                this._isShown ||
                                    ...
                                    p(this._element).on(lt.CLICK_DISMISS, '[data-dismiss="modal"]', function (e) {
                                        return t.hide(e);
                                    }),
        ...
        var _t = "tooltip",
            ...
            At = { AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left" },
            Dt = {
                animation: !0,
                ...
                return (
                    ...
                    (e.hide = function (e) {
                        var t = this,
                            ...
                            r = function () {
                                t._hoverState !== Nt && n.parentNode && n.parentNode.removeChild(n),
                                    t._cleanTipClass(),
                    ...
                    (e.setElementContent = function (e, t) {
                        "object" != typeof t || (!t.nodeType && !t.jquery)
                            ? this.config.html
                                ? (this.config.sanitize && (t = yt(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t))
                                : e.text(t)
                            : this.config.html
                    ...
                    (e._getConfig = function (e) {
                        ...
                        return (
                            ...
                            e.sanitize && (e.template = yt(e.template, e.whiteList, e.sanitizeFn)),
                            e
                        );
                    }),
        ...
        var Ht = "popover",
            ...
            Bt = l({}, Rt.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
        ...
        var $t = "scrollspy",
            ...
            Jt = { ACTIVATE: "activate" + Qt, SCROLL: "scroll" + Qt, LOAD_DATA_API: "load" + Qt + ".data-api" },
            Zt = "active",
            en = ".nav, .list-group",
            tn = ".nav-link",
            nn = ".list-group-item",
            ...
            on = (function () {
                function n(e, t) {
                    ...
                    (this._element = e),
                        ...
                        (this._config = this._getConfig(t)),
                        (this._selector = this._config.target + " " + tn + "," + this._config.target + " " + nn + "," + this._config.target + " .dropdown-item"),
                        (this._offsets = []),
                        (this._targets = []),
                ...
                return (
                    ...
                    (e._activate = function (t) {
                        ...
                        n.hasClass("dropdown-item")
                            ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(Zt), n.addClass(Zt))
                            : (n.addClass(Zt),
                              n
                                  .parents(en)
                                  .prev(tn + ", " + nn)
        ...
        var sn = "bs.tab",
            an = "." + sn,
            ln = p.fn.tab,
            un = { HIDE: "hide" + an, HIDDEN: "hidden" + an, SHOW: "show" + an, SHOWN: "shown" + an, CLICK_DATA_API: "click" + an + ".data-api" },
            cn = "active",
            hn = ".active",
            fn = "> li > .active",
            dn = (function () {
        ...
        var pn = "toast",
            ...
            mn = "." + gn,
            vn = p.fn[pn],
            yn = { CLICK_DISMISS: "click.dismiss" + mn, HIDE: "hide" + mn, HIDDEN: "hidden" + mn, SHOW: "show" + mn, SHOWN: "shown" + mn },
            _n = "show",
            bn = "showing",
                ...
                return (
                                ...
                                .on(u.CLICK_DATA_API, function (e) {
                                    ...
                                    o._config.preventDefault && e.preventDefault(),
                                        "true" !== t.attr("aria-disabled") &&
                                            (n.hasClass(o._config.activeClass) ? (t.attr("aria-expanded", !1), o._hide(r)) : (o._show(r), t.attr("aria-expanded", !0), o._config.toggle && i.attr("aria-expanded", !1)),
                    ...
                    (r.prototype._show = function (e) {
                        if (!this._transitioning && !s(e).hasClass(this._config.collapsingClass)) {
                            ...
                            if ((n.trigger(i), !i.isDefaultPrevented())) {
                                n.parent(this._config.parentTrigger).addClass(this._config.activeClass),
                                    this._config.toggle &&
                                        this._hide(
                                            n
                                ...
                                var r = function () {
                                    n
                                        ...
                                        .addClass(t._config.collapseClass + " " + t._config.collapseInClass)
                                        .height("")
                                        .attr("aria-expanded", !0),
                    ...
                    (r.prototype._hide = function (e) {
                        if (!this._transitioning && s(e).hasClass(this._config.collapseInClass)) {
                            var t = this,
                                ...
                                i = s.Event(u.HIDE);
                            if ((n.trigger(i), !i.isDefaultPrevented())) {
                                n.parent(this._config.parentTrigger).removeClass(this._config.activeClass),
                                ...
                                var r = function () {
                                    t._transitioning && t._config.onTransitionEnd && t._config.onTransitionEnd(),
                                        t.setTransitioning(!1),
                                        n.trigger(u.HIDDEN),
                                        n.removeClass(t._config.collapsingClass).addClass(t._config.collapseClass).attr("aria-expanded", !1);
                                };
                    ...
                    (r.prototype.dispose = function () {
                        s.removeData(this._element, a),
                            s(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).off("click"),
                            (this._transitioning = null),
                            (this._config = null),
                            (this._element = null);
                    }),
        ...
        (e = function (R) {
            ...
            (e = function () {
                return {
                    ...
                    discrete: { lineHeight: "auto", thresholdColor: U, thresholdValue: 0, chartRangeMax: U, chartRangeMin: U, chartRangeClip: !1, tooltipFormat: new v("{{prefix}}{{value}}{{suffix}}") },
                    bullet: {
                        targetColor: "#f33",
                        targetWidth: 3,
                ...
                (t = function () {
                    ...
                    return (
                        ...
                        1 < arguments.length
                            ? (arguments[0] ? ((e.prototype = R.extend(new arguments[0](), arguments[arguments.length - 1])), (e._super = arguments[0].prototype)) : (e.prototype = arguments[arguments.length - 1]),
                              2 < arguments.length && ((t = Array.prototype.slice.call(arguments, 1, -1)).unshift(e.prototype), R.extend.apply(R, t)))
                            ...
                            return (
                                ...
                                (s = u[r]) === U
                                    ...
                                    ? t[o].get
                                        ? t[o].get(s) || s
                                        : t[o][s] || s
                                    : (c(s) && (s = n.get("numberFormatter") ? n.get("numberFormatter")(s) : h(s, a, n.get("numberDigitGroupCount"), n.get("numberDigitGroupSep"), n.get("numberDecimalMark"))), s)
                            );
                        });
                    },
                })),
                ...
                (b = function (e, t) {
                    var n;
                    return 2 === t
                        ? ((n = B.floor(e.length / 2)), e.length % 2 ? e[n] : (e[n - 1] + e[n]) / 2)
                        : e.length % 2
                        ? (n = (e.length * t + t) / 4) % 1
                ...
                (n = function (e) {
                    ...
                    ((t = E.createElement("style")).type = "text/css"),
                        ...
                        n ? (E.styleSheets[E.styleSheets.length - 1].cssText = e) : (t["string" == typeof E.body.style.WebkitAppearance ? "innerText" : "innerHTML"] = e);
                }),
                ...
                (R.fn.sparkline = function (u, n) {
                    return this.each(function () {
                        ...
                        if (
                            ((e = function () {
                                var e, t, n, i, r, o, s;
                                "html" === u || u === U ? (((s = this.getAttribute(a.get("tagValuesAttribute"))) !== U && null !== s) || (s = l.html()), (e = s.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(","))) : (e = u),
                                    (t = "auto" === a.get("width") ? e.length * a.get("defaultPixelsPerValue") : a.get("width")),
                                    "auto" === a.get("height")
                                        ? (a.get("composite") && R.data(this, "_jqs_vcanvas")) || (((i = E.createElement("span")).innerHTML = "a"), l.html(i), (n = R(i).innerHeight() || R(i).height()), R(i).remove(), (i = null))
                                        : (n = a.get("height")),
                                    a.get("disableInteraction") ? (r = !1) : (r = R.data(this, "_jqs_mhandler")) ? a.get("composite") || r.reset() : ((r = new f(this, a)), R.data(this, "_jqs_mhandler", r)),
                                    !a.get("composite") || R.data(this, "_jqs_vcanvas")
                                        ? ((o = new R.fn.sparkline[a.get("type")](this, e, a, t, n)).render(), r && r.registerSparkline(o))
                            ...
                            if (!a.get("composite") && R.data(this, "_jqs_pending")) for (t = y.length; t; t--) y[t - 1][0] == this && y.splice(t - 1, 1);
                    ...
                    for (t = 0, n = y.length; t < n; t++)
                        (e = y[t][0]),
                            R(e).is(":visible") && !R(e).parents().is(":hidden")
                                ? (y[t][1].call(e), R.data(y[t][0], "_jqs_pending", !1), i.push(t))
                                : R(e).closest("html").length || R.data(e, "_jqs_pending") || (R.data(y[t][0], "_jqs_pending", !1), i.push(t));
                ...
                (R.fn.sparkline.options = t({
                    init: function (e, t) {
                        ...
                        (this.userOptions = t = t || {}),
                            ...
                            (n = (o = this.getTagSetting("type")) === _ ? i[t.type || r.type] : i[o]),
                    ...
                    getTagSetting: function (e) {
                        ...
                        if (this.tagValCache.hasOwnProperty(e)) t = this.tagValCache.key;
                            ...
                            else if ("[" === t.substr(0, 1)) for (n = (t = t.substr(1, t.length - 2).split(",")).length; n--; ) t[n] = M(t[n].replace(/(^\s*)|(\s*$)/g, ""));
                            else if ("{" === t.substr(0, 1)) for (i = t.substr(1, t.length - 2).split(","), t = {}, n = i.length; n--; ) t[(r = i[n].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = M(r[1].replace(/(^\s*)|(\s*$)/g, ""));
                            else t = M(t);
                ...
                (R.fn.sparkline._base = t({
                    ...
                    setRegionHighlight: function (e, t, n) {
                        ...
                        return t > this.canvasWidth || n > this.canvasHeight || t < 0 || n < 0
                            ? null
                            : r !== (i = this.getRegion(e, t, n)) && (r !== U && o && this.removeHighlight(), (this.currentRegion = i) !== U && o && this.renderHighlight(), !0);
                    },
                    ...
                    getCurrentRegionTooltip: function () {
                        ...
                        for (n = t.length, f = e.length, o = 0; o < n; o++)
                            for ("string" == typeof (h = t[o]) && (h = new v(h)), i = h.fclass || "jqsfield", d = 0; d < f; d++)
                                (e[d].isNull && p.get("tooltipSkipNull")) ||
                                    (R.extend(e[d], { prefix: p.get("tooltipPrefix"), suffix: p.get("tooltipSuffix") }), (r = h.render(e[d], p.get("tooltipValueLookups"), p)), m.push('<div class="' + i + '">' + r + "</div>"));
                ...
                (R.fn.sparkline.line = k = t(R.fn.sparkline._base, {
                    ...
                    renderHighlight: function () {
                        ...
                        r &&
                            (s && a && ((e = i.drawCircle(r[0], r[1], s, U, a)), (this.highlightSpotId = e.id), i.insertAfterShape(this.lastShapeId, e)),
                            l && ((t = i.drawLine(r[0], this.canvasTop, r[0], this.canvasTop + this.canvasHeight, l)), (this.highlightLineId = t.id), i.insertAfterShape(this.lastShapeId, t)));
                    },
                    removeHighlight: function () {
                        var e = this.target;
                    ...
                    scanValues: function () {
                        ...
                        for (e = 0; e < s; e++)
                            (t = o[e]),
                                ...
                                (r = n && o[e].split(":")),
                                n && 2 === r.length
                                    ? (a.push(Number(r[0])), l.push(Number(r[1])), u.push(Number(r[1])))
                                    : i
                                    ? (a.push(t[0]), l.push(t[1]), u.push(t[1]))
                                    : (a.push(e), null === o[e] || "null" === o[e] ? l.push(null) : (l.push(Number(t)), u.push(Number(t))));
                    ...
                    processRangeOptions: function () {
                        ...
                        t !== U && (t < this.miny && (this.miny = t), n > this.maxy && (this.maxy = n)),
                            e.get("chartRangeMin") !== U && (e.get("chartRangeClip") || e.get("chartRangeMin") < this.miny) && (this.miny = e.get("chartRangeMin")),
                            e.get("chartRangeMax") !== U && (e.get("chartRangeClip") || e.get("chartRangeMax") > this.maxy) && (this.maxy = e.get("chartRangeMax")),
                            e.get("chartRangeMinX") !== U && (e.get("chartRangeClipX") || e.get("chartRangeMinX") < this.minx) && (this.minx = e.get("chartRangeMinX")),
                            e.get("chartRangeMaxX") !== U && (e.get("chartRangeClipX") || e.get("chartRangeMaxX") > this.maxx) && (this.maxx = e.get("chartRangeMaxX"));
                    },
                        ...
                        if (k._super.render.call(this) && (this.scanValues(), this.processRangeOptions(), (w = this.xvalues), (C = this.yvalues), this.yminmax.length && !(this.yvalues.length < 2))) {
                            for (
                                i = r = 0,
                                    ...
                                    N && (S < 4 * N || A < 4 * N) && (N = 0),
                                    N &&
                                        (((_ = E.get("highlightSpotColor") && !E.get("disableInteraction")) || E.get("minSpotColor") || (E.get("spotColor") && C[n] === this.miny)) && (A -= B.ceil(N)),
                                        (_ || E.get("maxSpotColor") || (E.get("spotColor") && C[n] === this.maxy)) && ((A -= B.ceil(N)), (i += B.ceil(N))),
                                        (_ || ((E.get("minSpotColor") || E.get("maxSpotColor")) && (C[0] === this.miny || C[0] === this.maxy))) && ((r += B.ceil(N)), (S -= B.ceil(N))),
                                        (_ || E.get("spotColor") || E.get("minSpotColor") || (E.get("maxSpotColor") && (C[n] === this.miny || C[n] === this.maxy))) && (S -= B.ceil(N))),
                                    A--,
                                    E.get("normalRangeMin") === U || E.get("drawNormalOnTop") || this.drawNormalRange(r, i, A, S, t),
                                    a = [(s = [])],
                                    f = d = null,
                                    p = C.length,
                                    x = 0;
                                ...
                                (l = w[x]),
                                    (c = w[x + 1]),
                                    (u = C[x]),
                                    (d = (h = r + B.round((l - this.minx) * (S / e))) + ((x < p - 1 ? r + B.round((c - this.minx) * (S / e)) : S) - h) / 2),
                                    (I[x] = [f || 0, d, x]),
                                    (f = d),
                                    null === u
                                        ? x && (null !== C[x - 1] && ((s = []), a.push(s)), D.push(null))
                                        : (u < this.miny && (u = this.miny), u > this.maxy && (u = this.maxy), s.length || s.push([h, i + A]), (o = [h, i + B.round(A - A * ((u - this.miny) / t))]), s.push(o), D.push(o));
                            for (g = [], m = [], v = a.length, x = 0; x < v; x++)
                                (s = a[x]).length && (E.get("fillColor") && (s.push([s[s.length - 1][0], i + A]), m.push(s.slice(0)), s.pop()), 2 < s.length && (s[0] = [s[0][0], s[1][1]]), g.push(s));
                            ...
                            if (N && E.get("valueSpots"))
                                for ((y = E.get("valueSpots")).get === U && (y = new W(y)), x = 0; x < p; x++)
                                    (b = y.get(C[x])) && T.drawCircle(r + B.round((w[x] - this.minx) * (S / e)), i + B.round(A - A * ((C[x] - this.miny) / t)), N, U, b).append();
                            N && E.get("spotColor") && null !== C[n] && T.drawCircle(r + B.round((w[w.length - 1] - this.minx) * (S / e)), i + B.round(A - A * ((C[n] - this.miny) / t)), N, U, E.get("spotColor")).append(),
                                this.maxy !== this.minyorg &&
                                    (N &&
                                        E.get("minSpotColor") &&
                                        ((l = w[R.inArray(this.minyorg, C)]), T.drawCircle(r + B.round((l - this.minx) * (S / e)), i + B.round(A - A * ((this.minyorg - this.miny) / t)), N, U, E.get("minSpotColor")).append()),
                                    N &&
                                        E.get("maxSpotColor") &&
                                        ((l = w[R.inArray(this.maxyorg, C)]), T.drawCircle(r + B.round((l - this.minx) * (S / e)), i + B.round(A - A * ((this.maxyorg - this.miny) / t)), N, U, E.get("maxSpotColor")).append())),
                ...
                (R.fn.sparkline.bar = F = t(R.fn.sparkline._base, r, {
                    ...
                    init: function (e, t, n, i, r) {
                        var o,
                            ...
                            k = 1 / 0,
                            O = -1 / 0;
                        for (F._super.init.call(this, e, t, n, i, r), c = 0, h = t.length; c < h; c++)
                            ((o = "string" == typeof (E = t[c]) && -1 < E.indexOf(":")) || R.isArray(E)) &&
                                ((_ = !0), o && (E = t[c] = P(E.split(":"))), (E = q(E, null)), (s = B.min.apply(B, E)) < k && (k = s), O < (a = B.max.apply(B, E)) && (O = a));
                        (this.stacked = _),
                            (this.regionShapes = {}),
                            (this.barWidth = S),
                            (this.barSpacing = A),
                        ...
                        for (c = 0, h = t.length; c < h; c++)
                            if (_)
                                for (b = t[c], t[c] = x = [], L[c] = 0, l[c] = j[c] = 0, w = 0, C = b.length; w < C; w++)
                                    null !== (E = x[w] = I ? H(b[w], v, y) : b[w]) && (0 < E && (L[c] += E), k < 0 && 0 < O ? (E < 0 ? (j[c] += B.abs(E)) : (l[c] += E)) : (l[c] += B.abs(E - (E < 0 ? O : k))), u.push(E));
                        ...
                        (this.max = m = B.max.apply(B, u)),
                            ...
                            n.get("chartRangeMin") !== U && (n.get("chartRangeClip") || n.get("chartRangeMin") < g) && (g = n.get("chartRangeMin")),
                            n.get("chartRangeMax") !== U && (n.get("chartRangeClip") || n.get("chartRangeMax") > m) && (m = n.get("chartRangeMax")),
                            (this.zeroAxis = d = n.get("zeroAxis", !0)),
                            (p = g <= 0 && 0 <= m && d ? 0 : 0 == d ? g : 0 < g ? g : m),
                            (this.xaxisOffset = p),
                            (f = _ ? B.max.apply(B, l) + B.max.apply(B, j) : m - g),
                            (this.canvasHeightEf = d && g < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
                            g < p ? (T = (((_ && 0 <= m ? O : m) - p) / f) * this.canvasHeight) !== B.ceil(T) && ((this.canvasHeightEf -= 2), (T = B.ceil(T))) : (T = this.canvasHeight),
                            (this.yoffset = T),
                            R.isArray(n.get("colorMap"))
                                ? ((this.colorMapByIndex = n.get("colorMap")), (this.colorMapByValue = null))
                                : ((this.colorMapByIndex = null), (this.colorMapByValue = n.get("colorMap")), this.colorMapByValue && this.colorMapByValue.get === U && (this.colorMapByValue = new W(this.colorMapByValue))),
                            (this.range = f);
                    },
                    getRegion: function (e, t, n) {
                    ...
                    getCurrentRegionFields: function () {
                        var e,
                            ...
                            i = o(this.values[n]),
                            r = [];
                        for (t = i.length; t--; ) (e = i[t]), r.push({ isNull: null === e, value: e, color: this.calcColor(t, e, n), offset: n });
                        return r;
                    },
                    calcColor: function (e, t, n) {
                        var i,
                            ...
                            a = this.options;
                        return (
                            (i = this.stacked ? a.get("stackedBarColor") : t < 0 ? a.get("negBarColor") : a.get("barColor")),
                    ...
                    renderRegion: function (e, t) {
                        var n,
                            ...
                            w = this.yoffset;
                        if (((l = (f = R.isArray(f) ? f : [f]).length), (u = f[0]), (o = C(null, f)), (h = C(p, f, !0)), o))
                            return d.get("nullColor") ? ((r = t ? d.get("nullColor") : this.calcHighlightColor(d.get("nullColor"), d)), (n = 0 < w ? w - 1 : w), y.drawRect(_, n, this.barWidth - 1, 0, r, r)) : U;
                        for (s = w, a = 0; a < l; a++) {
                            if (((u = f[a]), v && u === p)) {
                                if (!h || c) continue;
                                c = !0;
                ...
                (R.fn.sparkline.tristate = a = t(R.fn.sparkline._base, r, {
                    ...
                    getCurrentRegionFields: function () {
                        var e = this.currentRegion;
                        return { isNull: this.values[e] === U, value: this.values[e], color: this.calcColor(this.values[e], e), offset: e };
                    },
                    ...
                    renderRegion: function (e, t) {
                        var n,
                            ...
                            u = this.options,
                            c = this.target;
                        if (((n = c.pixelHeight), (r = B.round(n / 2)), (o = e * this.totalBarWidth), l[e] < 0 ? (i = (s = r) - 1) : 0 < l[e] ? ((s = 0), (i = r - 1)) : ((s = r - 1), (i = 2)), null !== (a = this.calcColor(l[e], e))))
                            return t && (a = this.calcHighlightColor(a, u)), c.drawRect(o, s, this.barWidth - 1, i - 1, a, a);
                    },
                })),
                (R.fn.sparkline.discrete = s = t(R.fn.sparkline._base, r, {
                    ...
                    init: function (e, t, n, i, r) {
                        s._super.init.call(this, e, t, n, i, r),
                            ...
                            (this.width = i = "auto" === n.get("width") ? 2 * t.length : this.width),
                            (this.interval = B.floor(i / t.length)),
                            (this.itemWidth = i / t.length),
                            n.get("chartRangeMin") !== U && (n.get("chartRangeClip") || n.get("chartRangeMin") < this.min) && (this.min = n.get("chartRangeMin")),
                            n.get("chartRangeMax") !== U && (n.get("chartRangeClip") || n.get("chartRangeMax") > this.max) && (this.max = n.get("chartRangeMax")),
                            this.initTarget(),
                            this.target && (this.lineHeight = "auto" === n.get("lineHeight") ? B.round(0.3 * this.canvasHeight) : n.get("lineHeight"));
                    },
                    getRegion: function (e, t, n) {
                    ...
                    getCurrentRegionFields: function () {
                        var e = this.currentRegion;
                        return { isNull: this.values[e] === U, value: this.values[e], offset: e };
                    },
                    renderRegion: function (e, t) {
                        var n,
                            i,
                        ...
                        return (
                            ...
                            (o = e * h),
                            (n = B.round(g - g * ((i - l) / c))),
                            (r = a.get("thresholdColor") && i < a.get("thresholdValue") ? a.get("thresholdColor") : a.get("lineColor")),
                ...
                (R.fn.sparkline.bullet = l = t(R.fn.sparkline._base, {
                    ...
                    renderPerformance: function (e) {
                        ...
                        return e && (i = this.calcHighlightColor(i, this.options)), this.target.drawRect(0, B.round(0.3 * this.canvasHeight), n - 1, B.round(0.4 * this.canvasHeight) - 1, i, i);
                    },
                ...
                (R.fn.sparkline.pie = u = t(R.fn.sparkline._base, {
                    ...
                    getCurrentRegionFields: function () {
                        var e = this.currentRegion;
                        return { isNull: this.values[e] === U, value: this.values[e], percent: (this.values[e] / this.total) * 100, color: this.options.get("sliceColors")[e % this.options.get("sliceColors").length], offset: e };
                    },
                    changeHighlight: function (e) {
                    ...
                    renderSlice: function (e, t) {
                        ...
                        for (o = d.length, r = 0; r < o; r++) {
                            if (((i = n = g), 0 < p && (i = g + f * (d[r] / p)), e === r))
                                return (s = l.get("sliceColors")[r % l.get("sliceColors").length]), t && (s = this.calcHighlightColor(s, l)), a.drawPieSlice(u, u, u - c, n, i, U, s);
                            g = i;
                        }
                    },
                    render: function () {
                ...
                (R.fn.sparkline.box = w = t(R.fn.sparkline._base, {
                    ...
                    getCurrentRegionFields: function () {
                        ...
                        return (
                            this.loutlier !== U && e.push({ field: "lo", value: this.loutlier }),
                            this.routlier !== U && e.push({ field: "ro", value: this.routlier }),
                            this.lwhisker !== U && e.push({ field: "lw", value: this.lwhisker }),
                            this.rwhisker !== U && e.push({ field: "rw", value: this.rwhisker }),
                            e
                        );
                    },
                    render: function () {
                        ...
                        if (w._super.render.call(this)) {
                            ...
                            (this.quartiles = [i, r, o]),
                                ...
                                p.get("showOutliers") &&
                                    ...
                                    t < e && h.drawCircle((t - v) * c + _, m / 2, p.get("spotRadius"), p.get("outlierLineColor"), p.get("outlierFillColor")).append(),
                                    s < a && h.drawCircle((a - v) * c + _, m / 2, p.get("spotRadius"), p.get("outlierLineColor"), p.get("outlierFillColor")).append()),
                                h.drawRect(B.round((i - v) * c + _), B.round(0.1 * m), B.round((o - i) * c), B.round(0.8 * m), p.get("boxLineColor"), p.get("boxFillColor")).append(),
                                h.drawLine(B.round((e - v) * c + _), B.round(m / 2), B.round((i - v) * c + _), B.round(m / 2), p.get("lineColor")).append(),
                                h.drawLine(B.round((e - v) * c + _), B.round(m / 4), B.round((e - v) * c + _), B.round(m - m / 4), p.get("whiskerColor")).append(),
                                h.drawLine(B.round((s - v) * c + _), B.round(m / 2), B.round((o - v) * c + _), B.round(m / 2), p.get("lineColor")).append(),
                                h.drawLine(B.round((s - v) * c + _), B.round(m / 4), B.round((s - v) * c + _), B.round(m - m / 4), p.get("whiskerColor")).append(),
                                h.drawLine(B.round((r - v) * c + _), B.round(0.1 * m), B.round((r - v) * c + _), B.round(0.9 * m), p.get("medianColor")).append(),
                                p.get("target") &&
                                    ((u = B.ceil(p.get("spotRadius"))),
                                    h.drawLine(B.round((p.get("target") - v) * c + _), B.round(m / 2 - u), B.round((p.get("target") - v) * c + _), B.round(m / 2 + u), p.get("targetColor")).append(),
                                    h.drawLine(B.round((p.get("target") - v) * c + _ - u), B.round(m / 2), B.round((p.get("target") - v) * c + _ + u), B.round(m / 2), p.get("targetColor")).append()),
                                h.render();
                        }
                    },
                })),
                ...
                (g = t(p, {
                    init: function (e, t, n, i) {
                        g._super.init.call(this, e, t, n),
                            ...
                            R(this.canvas).css({ display: "inline-block", width: e, height: t, verticalAlign: "top" }),
                    ...
                    _drawShape: function (e, t, n, i, r) {
                        ...
                        for (a.beginPath(), a.moveTo(t[0][0] + 0.5, t[0][1] + 0.5), o = 1, s = t.length; o < s; o++) a.lineTo(t[o][0] + 0.5, t[o][1] + 0.5);
                    ...
                    _drawPieSlice: function (e, t, n, i, r, o, s, a) {
                        ...
                        l.beginPath(),
                            ...
                            s !== U && l.stroke(),
                            a && l.fill(),
                            this.targetX !== U && this.targetY !== U && l.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = e);
                    },
                ...
                (m = t(p, {
                    init: function (e, t, n) {
                        ...
                        m._super.init.call(this, e, t, n),
                            ...
                            R(this.canvas).css({ display: "inline-block", position: "relative", overflow: "hidden", width: e, height: t, margin: "0px", padding: "0px", verticalAlign: "top" }),
                            this._insert(this.canvas, n),
                            this._calculatePixelDims(e, t, this.canvas),
                            (this.canvas.width = this.pixelWidth),
                            (this.canvas.height = this.pixelHeight),
                    ...
                    _drawShape: function (e, t, n, i, r) {
                        ...
                        return (
                            (o = h.splice(0, 1)),
                            (r = r === U ? 1 : r),
                            (s = n === U ? ' stroked="false" ' : ' strokeWeight="' + r + 'px" strokeColor="' + n + '" '),
                            (a = i === U ? ' filled="false"' : ' fillColor="' + i + '" filled="true" '),
                    ...
                    _drawCircle: function (e, t, n, i, r, o, s) {
                        return (
                            ...
                            e +
                            '" ' +
                            (r === U ? ' stroked="false" ' : ' strokeWeight="' + s + 'px" strokeColor="' + r + '" ') +
                            (o === U ? ' filled="false"' : ' fillColor="' + o + '" filled="true" ') +
                    ...
                    _drawPieSlice: function (e, t, n, i, r, o, s, a) {
                        ...
                        return u === h && c === f && o - r < B.PI
                            ...
                            : ((l = [t - i, n - i, t + i, n + i, u, c, h, f]),
                              (d = s === U ? ' stroked="false" ' : ' strokeWeight="1px" strokeColor="' + s + '" '),
                              (p = a === U ? ' filled="false"' : ' fillColor="' + a + '" filled="true" '),
                              '<v:shape coordorigin="0 0" coordsize="' +
                                  this.pixelWidth +
                                  " " +
                                  this.pixelHeight +
    ...
    function (e, t) {
        e.exports = function (e, t, n, i) {
            return ((i = i || {}).test && i.getElementsByClassName) || (!i.test && document.getElementsByClassName)
                ? ((s = e), (a = t), n ? s.getElementsByClassName(a)[0] : s.getElementsByClassName(a))
                : (i.test && i.querySelector) || (!i.test && document.querySelector)
                ? ((r = e), (o = "." + (o = t)), n ? r.querySelector(o) : r.querySelectorAll(o))
                : (function (e, t, n) {
            ...
            (i = {
                start: function () {
                    (a.listClass = "list"),
                        ...
                        (a.handlers = { updated: [] }),
                        (a.valueNames = []),
                        (a.utils = { getByClass: c, extend: h, indexOf: f, events: d, toString: p, naturalSort: s, classes: g, getAttribute: m, toArray: v }),
                        a.utils.extend(a, n),
                ...
                (this.update = function () {
                    ...
                    for (var n = 0; n < t; n++)
                        e[n].matching() && a.matchingItems.length + 1 >= a.i && a.visibleItems.length < a.page
                            ? (e[n].show(), a.visibleItems.push(e[n]), a.matchingItems.push(e[n]))
        ...
        e.exports = function (d) {
            var n = function (e, t) {
                    ...
                    for (var h = 1; h <= s; h++) {
                        var f = a === h ? "active" : "";
                        p.number(h, u, c, a, l)
                            ? ((n = e.add({ page: h, dotted: !1 })[0]), f && m(n.elm).add(f), g(n.elm, h, o))
                            : p.dotted(e, h, u, c, a, l, e.size()) && ((n = e.add({ page: "...", dotted: !0 })[0]), m(n.elm).add("disabled"));
                    }
                },
                p = {
        ...
        e.exports = function (o) {
            var s = {
                ...
                e = function () {
                    ...
                    e
                        ? ((i.valueName = o.utils.getAttribute(e, "data-sort")), s.getInSensitive(e, i), (i.order = s.getOrder(e)))
        ...
        var n = function (l) {
            ...
            (this.clearSourceItem = function (e, t) {
                for (var n = 0, i = t.length; n < i; n++) {
                    var r;
                    if (t[n].data) for (var o = 0, s = t[n].data.length; o < s; o++) e.setAttribute("data-" + t[n].data[o], "");
                ...
                (this.get = function (e, t) {
                    ...
                    for (var n = {}, i = 0, r = t.length; i < r; i++) {
                        var o;
                        if (t[i].data) for (var s = 0, a = t[i].data.length; s < a; s++) n[t[i].data[s]] = l.utils.getAttribute(e.elm, "data-" + t[i].data[s]);
                        else
                            t[i].attr && t[i].name
                                ? ((o = l.utils.getByClass(e.elm, t[i].name, !0)), (n[t[i].name] = o ? l.utils.getAttribute(o, t[i].attr) : ""))
                                : ((o = l.utils.getByClass(e.elm, t[i], !0)), (n[t[i]] = o ? o.innerHTML : ""));
                        o = void 0;
                    }
                    return n;
                }),
                (this.set = function (r, e) {
                    var t = function (e, t) {
                            ...
                            i = (function (e) {
                                for (var t = 0, n = l.valueNames.length; t < n; t++)
                                    if (l.valueNames[t].data) {
                                        for (var i = l.valueNames[t].data, r = 0, o = i.length; r < o; r++) if (i[r] === e) return { data: e };
                                    } else {
                        ...
                        i &&
                            (i.data ? r.elm.setAttribute("data-" + i.data, t) : i.attr && i.name ? (n = l.utils.getByClass(r.elm, i.name, !0)) && n.setAttribute(i.attr, t) : (n = l.utils.getByClass(r.elm, i, !0)) && (n.innerHTML = t),
                            (n = void 0));
                    };
